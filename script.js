...
(function() {
        ...
        form.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    formStatus.textContent = 'حدث خطأ في إرسال الرسالة. يرجى المحاولة مرة أخرى';
                    formStatus.style.color = '#ef4444';
                }
            } catch (error) {
                formStatus.textContent = 'حدث خطأ في إرسال الرسالة. يرجى المحاولة مرة أخرى';
    ...
    // Initialize language switch button text
    if (langSwitchBtn) {
        langSwitchBtn.textContent = 'عربي'; // Since currentLang is 'en', show 'عربي' to switch to Arabic
    }
    ...
    const translations = {
        ar: {
            ...
            'نفخر بثقة شركائنا وعملائنا': 'نفخر بثقة شركائنا وعملائنا',
            ...
            'نقدم خدماتنا بسرعة وكفاءة عالية، مع مرونة في التوقيت لتناسب احتياجات عملائنا': 'نقدم خدماتنا بسرعة وكفاءة عالية، مع مرونة في التوقيت لتناسب احتياجات عملائنا',
            ...
            'fast_service_title': 'خدمة سريعة وفعالة',
            'careers_subtitle': 'نبحث عن مواهب متميزة لتنمية فريقنا المتخصص',
            'why_choose_work_title': 'لماذا تختار العمل معنا؟',
            'careers_note': 'أرسل سيرتك الذاتية مع خطاب تغطية',
            ...
            'nav_about_overview': 'نظرة عامة',
            'nav_about_timeline': 'الجدول الزمني',
            'nav_about_services': 'خدماتنا',
            'nav_about_global': 'الوصول العالمي',
            'nav_about_customers': 'عملاؤنا',
            'nav_specialty': 'تخصصنا',
            'nav_specialty_about': 'معلومات عنا',
            'nav_specialty_values': 'قيمنا',
            'nav_specialty_timeline': 'رحلتنا عبر الزمن',
            'nav_specialty_business': 'خطوط أعمالنا',
            'nav_specialty_logistics': 'الحلول اللوجستية',
            'nav_specialty_services': 'الخدمات المتخصصة',
            'nav_specialty_contact': 'التواصل والاتصال',
            'nav_specialty_customers': 'عملاؤنا',
            'nav_careers': 'التوظيف',
            'nav_partners': 'شركاؤنا',
            'nav_contact': 'إتصل بنا',
            'footer_description': 'مجموعة شركات رائدة بأكثر من 43 عاماً من الخبرة في مجالات متعددة',
            'footer_quick_links': 'روابط سريعة',
            'footer_our_services': 'خدماتنا',
            'footer_contact_us': 'إتصل بنا',
            'footer_copyright': '© 2025 تآزر. جميع الحقوق محفوظة.',
            'footer_privacy': 'سياسة الخصوصية',
            'footer_terms': 'الشروط والأحكام',
            'apply_job': 'تقديم طلب توظيف',
            'work_env': 'بيئة عمل محفزة ومهنية',
            'dev_opportunities': 'فرص تطوير وتدريب مستمر',
            'competitive_benefits': 'مزايا تنافسية وحزم تأمين شاملة',
            'diverse_projects': 'مشاريع متنوعة ومثيرة للاهتمام',
            'career_growth': 'فرص نمو وظيفي واضحة',
            'disability_welcome': 'نرحب بجميع الطلبات من ذوي الإعاقة مع ضمان بيئة عمل داعمة',
            'services_subtitle': 'نقدم مجموعة شاملة من الخدمات المتخصصة لتلبية احتياجات عملائنا',
            'partners_subtitle': 'نفخر بثقة شركائنا وعملائنا',
            'curtain_side_desc': 'للبضائع الجافة، تغطي دول مجلس التعاون الخليجي ومنطقة الأردن.',
            'pipeline_desc': 'نقل مواسير النفط والغاز وأنابيب البلاستيك وأنواع أخرى.',
            'logistics_services_desc': 'نحن نقدم خدمات 3PL و 4PL من خلال مواقعنا في دول مجلس التعاون الخليجي والأردن ومصر.',
            'flatbed_desc': 'جميع أنواع المواد المسطحة من 12 م إلى 18 م بناء على طلب العميل.',
            'fast_service_desc': 'نقدم خدماتنا بسرعة وكفاءة عالية، مع مرونة في التوقيت لتناسب احتياجات عملائنا',
            'slide_feature1': 'شاحنات مسطحة',
            'slide_feature2': 'شاحنات نقل',
            'slide_feature3': 'خدمة 24/7',
            'join_team_subtitle': 'انضم إلى فريق تآزر وكن جزءاً من نجاحنا المستمر',
            'join_team_title': 'انضم إلى فريق تآزر',
            'companies_title': 'بعض الشركات التي جربت خدماتنا',
            'job_opportunities_title': 'فرص عمل متاحة',
            'distinguished_services_title': 'خدماتنا المتميزة',
            'refrigerated_trucks_title': 'شاحنات مبردة',
            'flatbed_trucks_title': 'شاحنات مسطحة',
            'iso_tank_title': 'نقل خزانات ISO',
            'refrigerated_desc': 'نقل المواد الغذائية والطبية داخل المملكة.',
            'iso_tank_desc': 'نقل الكيماويات والبضائع الخطرة.',
            'about_title': 'معلومات عن تآزر',
            'about_description': 'نجاحنا يتحقق عندما يحصل عملاؤنا على فرصة لتجاوز توقعاتهم. نحن نؤمن بأن الشراكة الحقيقية مع عملائنا هي أساس النجاح المستدام.',
            'passionate_title': 'نحن متحمسون',
            'passionate_desc': 'لدينا سجل حافل بالإنجازات والنجاحات المثبتة',
            'trustworthy_title': 'جديرون بالثقة',
            'trustworthy_desc': 'الصدق بالنسبة لنا هو السياسة الوحيدة التي نتبعها',
            'evolving_title': 'نحن في تطور دائم',
            'evolving_desc': 'نلتزم بإكمال جميع المشاريع بأعلى معايير الجودة',
            'iso_title': 'شهادة الأيزو',
            'iso_desc': 'نظام إدارة الجودة ISO 9001 معتمد عالمياً',
            'why_choose_us_title': 'لماذا تختارنا؟',
            'why_choose_us_subtitle': 'نتميز بخبرة أكثر من 43 عاماً في تقديم أفضل الخدمات لعملائنا',
            'experience_title': 'خبرة أكثر من 43 عاماً',
            'quality_title': 'جودة عالية معتمدة',
            'quality_desc': 'نلتزم بأعلى معايير الجودة العالمية مع شهادة ISO 9001، لضمان رضا عملائنا التام',
            'experience_desc': 'نمتلك خبرة طويلة في مجالات المقاولات والخدمات اللوجستية، مما يجعلنا الخيار الأمثل لمشاريعكم',
            'team_title': 'فريق متخصص ومحترف',
            'team_desc': 'نوظف أفضل الكفاءات والخبرات في مجالنا، مع تدريب مستمر لضمان التميز في الأداء',
        },
        en: {
            'الرئيسية': 'Home',
            'خدماتنا': 'Services',
            ...
            'نفخر بثقة شركائنا وعملائنا': 'We are proud of our partners\' and clients\' trust',
            ...
            'للبضائع الجافة، تغطي دول مجلس التعاون الخليجي ومنطقة الأردن.': 'For dry goods, covering GCC countries and Jordan region.',
            ...
            'نقدم خدماتنا بسرعة وكفاءة عالية، مع مرونة في التوقيت لتناسب احتياجات عملائنا': 'We provide our services with high speed and efficiency, with flexibility in timing to suit our clients\' needs',
            ...
            'fast_service_title': 'Fast & Efficient Service',
            'careers_subtitle': 'We are looking for outstanding talents to develop our specialized team',
            'why_choose_work_title': 'Why Choose to Work With Us?',
            'careers_note': 'Send your CV with a cover letter',
            ...
            'nav_about_timeline': 'Timeline',
            'nav_about_services': 'Our Services',
            'nav_about_global': 'Global Reach',
            'nav_about_customers': 'Our Customers',
            'nav_specialty': 'Our Specialty',
            'nav_specialty_about': 'About Us',
            'nav_specialty_values': 'Our Values',
            'nav_specialty_timeline': 'Our Journey Through Time',
            'nav_specialty_business': 'Our Business Lines',
            'nav_specialty_logistics': 'Logistics Solutions',
            'nav_specialty_services': 'Specialized Services',
            'nav_specialty_contact': 'Contact & Communication',
            'nav_specialty_customers': 'Our Customers',
            'nav_careers': 'Careers',
            'nav_partners': 'Partners',
            'nav_contact': 'Contact Us',
            'footer_description': 'Leading group of companies with over 43 years of experience in multiple fields',
            'footer_quick_links': 'Quick Links',
            'footer_our_services': 'Our Services',
            'footer_contact_us': 'Contact Us',
            'footer_copyright': '© 2025 Taazur. All rights reserved.',
            'footer_privacy': 'Privacy Policy',
            'footer_terms': 'Terms & Conditions',
            'apply_job': 'Submit Job Application',
            'work_env': 'Stimulating and professional work environment',
            'dev_opportunities': 'Continuous development and training opportunities',
            'competitive_benefits': 'Competitive benefits and comprehensive insurance packages',
            'diverse_projects': 'Diverse and interesting projects',
            'career_growth': 'Clear career growth opportunities',
            'disability_welcome': 'We welcome all applications from people with disabilities with guaranteed supportive work environment',
            'services_subtitle': 'We provide a comprehensive range of specialized services to meet our clients\' needs',
            'partners_subtitle': 'We are proud of our partners\' and clients\' trust',
            'curtain_side_desc': 'For dry goods, covering GCC countries and Jordan region.',
            'pipeline_desc': 'Transportation of oil and gas pipes, plastic pipes and other types.',
            'logistics_services_desc': 'We provide 3PL and 4PL services through our locations in GCC countries, Jordan and Egypt.',
            'flatbed_desc': 'All types of flat materials from 12m to 18m based on customer request.',
            'fast_service_desc': 'We provide our services with high speed and efficiency, with flexibility in timing to suit our clients\' needs',
            'slide_feature1': 'Flatbed Trucks',
            'slide_feature2': 'Transport Trucks',
            'slide_feature3': '24/7 Service',
            'join_team_subtitle': 'Join Taazur team and be part of our continuous success',
            'join_team_title': 'Join Taazur Team',
            'companies_title': 'Some Companies That Have Tried Our Services',
            'job_opportunities_title': 'Available Job Opportunities',
            'distinguished_services_title': 'Our Distinguished Services',
            'refrigerated_trucks_title': 'Refrigerated Trucks',
            'flatbed_trucks_title': 'Flatbed Trucks',
            'iso_tank_title': 'ISO Tank Transportation',
            'refrigerated_desc': 'Transportation of food and medical materials within the Kingdom.',
            'iso_tank_desc': 'Transportation of chemicals and hazardous goods.',
            'about_title': 'About Taazur',
            'about_description': 'Our success is achieved when our clients have the opportunity to exceed their expectations. We believe that true partnership with our clients is the foundation of sustainable success.',
            'passionate_title': 'We are passionate',
            'passionate_desc': 'We have a proven track record of achievements and successes',
            'trustworthy_title': 'We are trustworthy',
            'trustworthy_desc': 'Honesty is the only policy we follow',
            'evolving_title': 'We are constantly evolving',
            'evolving_desc': 'We are committed to completing all projects to the highest quality standards',
            'iso_title': 'ISO Certification',
            'iso_desc': 'ISO 9001 Quality Management System is internationally certified',
            'why_choose_us_title': 'Why Choose Us?',
            'why_choose_us_subtitle': 'We have over 43 years of experience providing the best services to our clients',
            'experience_title': 'Over 43 Years of Experience',
            'quality_title': 'Certified High Quality',
            'quality_desc': 'We adhere to the highest global quality standards with ISO 9001 certification to ensure our clients\' complete satisfaction',
            'experience_desc': 'We have extensive experience in contracting and logistics fields, making us the ideal choice for your projects',
            'team_title': 'Specialized & Professional Team',
            'team_desc': 'We employ the best talents and expertise in our field, with continuous training to ensure excellence in performance',
        }
    };
